...
const GEOCODE = {
  ...
  airports: {
    ...
    LGW:[51.1537,-0.1821],LHR:[51.4700,-0.4543],LTN:[51.8747,-0.3683],MCO:[28.4312,-81.3081],MLA:[35.8575,14.4775],
    ...
    TPA:[27.9756,-82.5333],VIE:[48.1103,16.5697],ZRH:[47.4647,8.5492]
  },
  ports: {
    ...
    'Lombok':[-8.6507,116.3249],'Malaga':[36.7213,-4.4214],'Málaga':[36.7213,-4.4214],'Tangier':[35.7595,-5.8340],
  ...
  events: {
    ...
    'Anaheim':[33.8366,-117.9143],'Beerwah':[-26.8585,152.9607],
    'DMZ':[37.9565,126.6756],'Fayetteville':[35.0527,-78.8784],
    'Georgetown':[19.2948,-81.3647],'Grindavik':[63.8426,-22.4340],
    'Imola':[44.3535,11.7141],'Ko Olina':[21.3380,-158.1272],
